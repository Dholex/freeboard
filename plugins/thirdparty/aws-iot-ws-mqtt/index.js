...
(function () {
    ...
    var nodeJSDatasource = function (settings, updateCallback) {
        ...
        function init() {
            ...
            self.sessionToken = currentSettings.sessionToken;
            connect();
        }
    ...
    freeboard
        .loadDatasourcePlugin({
            ...
            external_scripts: [
                "plugins/thirdparty/aws-iot-ws-mqtt/core.js",
                "plugins/thirdparty/aws-iot-ws-mqtt/hmac.js",
                "plugins/thirdparty/aws-iot-ws-mqtt/moment.js",
                "plugins/thirdparty/aws-iot-ws-mqtt/sha256.js",
                "plugins/thirdparty/aws-iot-ws-mqtt/paho-mqtt.js"
            ],
            settings: [{
                name: "endpoint",
            ...
            },
            {
                ...
                description: "The AWS session token for profile with credentials for IoT endpoint.",
                type: "text"
            },
            {
                name: "topics",
